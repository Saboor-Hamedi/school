            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        <a class="sidebar-link" href="visit-student-account.php?id=<?php echo base64_encode($row['nim']); ?>">
                            ...
                            <div class="card-body" id="turn-on-scroll">
                                <div id="world_map" style="height: 350px;">
                                    ...
                                    <table class="table table-bordered table-dark">
                                        ...
                                        $query_rearch = mysqli_query($db->link, $query);
                                        while ($row = mysqli_fetch_array($query_rearch)) { ?>

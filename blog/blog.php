                ...
                <div class="left">
                    ...
                    <div class="create-post">
                        ...
                        <form method="POST" id="post-form">
                            ...
                            <div class="form-group">
                                <textarea name="post_author_id" wrap="physical" onkeyup="saveValue(this);" id="post_content" class="form-control" rows="5" placeholder="Your content...?" autocomplete="off"></textarea>
                            </div>
                    ...
                    <?php while ($row = $post->fetch_assoc()) { ?>
                        <div class="contents">
                            <div class="content-title">
                                ...
                                <?php if ($row['nim'] === $id) { ?>
                                    <div class="drop-down">
                                        <a class="toggle-dropdown"><i class="bx bx-dots-horizontal-rounded"></i></a>
                                        <div class="menu">
                                            <ul>
                            ...
                            <div class="post-body">
                                <h3>
                                    <a href=""><?php echo $fm->ToUpperCase($fm->RemoveHTML($row['title'])); ?></a>
                                </h3>
                            </div>

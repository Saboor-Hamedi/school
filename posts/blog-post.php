...
<?php $db = new Database(); ?>
<?php $fm = new format(); ?> <?php session_start(); ?>
<?php
$id = "";
...
<div class="post-insert">
    ...
    <form method="POST">
        <div class="form-group"><input type="text" name="post_title" id="post_title" class="form-control" placeholder="What is you title... ?" autocomplete="off" /></div>
        <div class="form-group">
            <textarea name="post_content" id="post_content" class="form-control" cols="30" rows="10" placeholder="Your content...?" autocomplete="off"></textarea></div>
        <div class="form-group">

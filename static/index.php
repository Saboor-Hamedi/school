                ...
                <div class="col-12 col-md-12 col-xxl-3 order-1 order-xxl-3">
                    <div class="card flex-fill w-100">
                        ...
                        <form id="admin_change_password_form" method="POST">
                            ...
                            <div class="form-box">
                                <input type="password" name="old_admin_password" class="form-control"
                                    id="old_admin_password" placeholder="Enter your old password" autocomplete="off" />
                                <input type="password" name="new_admin_password" class="form-control"
                                    id="new_admin_password" placeholder="Enter your new password"
                                    autocapitalize="off" />
                                <input type="password" name="confirm_admin_password" class="form-control"
                                    id="confirm_admin_password" placeholder="Confirm your new password"
                                    autocomplete="off" />
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="change_admin_password_btn"
                                    name="change_admin_password_btn">Change</button>
                            </div>
                        </form>
                    </div>
                </div>
                                ...
                                <table class="table table-bordered table-dark">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img src="../images/<?php echo $row['admin_image']; ?>"
                                                    alt="No image found" class="table_image" /></td>
                                        </tr>
                                    </tbody>
                                    <?php }
                                        }

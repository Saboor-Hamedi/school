            ...
            <div class="container">
                <div id="datetimepicker-dashboard">
                    <form method="post" id="admin_form" enctype="multipart/form-data">
                        ...
                        <div class="inputs">
                            <input type="text" name="admin_nim" oninput="process(this)" class="form-control" id="admin_nim" placeholder="Enter admin ID..." autocomplete="off" oninput="process(this)" />
                            <input type="text" name="admin_name" class="form-control" id="admin_name" placeholder="Enter admin name..." autocomplete="off" />
                            <input type="text" name="admin_lastname" class="form-control" id="admin_lastname" placeholder="Enter last name..." autocomplete="off" />
                            <input type="text" name="admin_email" oninput="isEmail(this)" class="form-control" id="admin_email" placeholder="Enter email..." autocomplete="off" />
                            <input type="password" name="admin_pass" class="form-control" id="admin_pass" placeholder="Enter password..." autocomplete="off" />
                            <input type="password" name="admin_conpass" class="form-control" id="admin_conpass" placeholder="Confirm password..." autocomplete="off" />
                        </div>
                        <div class="center">
                            <div class="admin-content-file">
                                ...
                                <input type="file" name="file" class="form-control" id="admin-file" accept="image/*" onchange="showPreview(event);" />

                    ...
                    <div class="card flex-fill w-100">
                        ...
                        <div class="card-body" id="turn-on-scroll">
                            ...
                            <form id="send_file_for_student_form" method="POST" enctype="multipart/form-data">
                                <div class="form-box">
                                    <input type="text" oninput="process(this)" name="student_insert_id_file" class="form-control" id="student_insert_id_file" placeholder="Enter student ID..." autocomplete="off" />
                                    <input type="text" oninput="process(this)" name="teacher_insert_id_file" class="form-control" id="teacher_insert_id_file" placeholder="Enter teacher ID..." autocapitalize="off" />
                                    <input type="text" name="file_insert_title" id="file_insert_title" class="form-control" placeholder="What is the title... ?" autocomplete="off" />
                                    <div style="margin-top: 5px;">
                                        <textarea cols="30" rows="10" name="file_description" class="form-control" id="file_description" placeholder="Type some description..." autocomplete="off"></textarea>
                                    </div>
                                    <input type="file" name="file" id="send_file" class="form-control" />
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary mr-auto" id="send_file_for_student_btn" name="send_file_for_student_btn">Send</button>
                                </div>
                            </form>
                        </div>
                    </div>

...
?>
                    ...
                    <div class="card flex-fill w-100">
                        ...
                        <form id="student_insert_form" method="POST">
                            <div class="form-box">
                                ...
                                <input type="text" class="form-control" id="insert_class_code" name="insert_class_code"
                                    placeholder="What is the class code...?" autocomplete="off" />
                                <input type="text" class="form-control" id="insert_class_name" name="insert_class_name"
                                    placeholder="What is the class name...?" autocomplete="off" />
                                <div style="margin-top: 5px;">
                                    <select name="insert_days_of_weeks_class" class="form-control"
                                        id="insert_days_of_weeks_class">
                                ...
                                <div style="margin-top: 5px;">
                                    ...
                                    <select name="insert_class_year_name" id="insert_class_year_name"
                                        class="form-control">
    ...
    while ($row = $query->fetch_assoc()) { ?>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="insert_class_start_time"
                                        name="insert_class_start_time" placeholder="Class start at...?"
                                        autocomplete="off" />
                                </div>
                                <!-- 
    ...
    if ($select_rows) {
        while ($row = $select_rows->fetch_assoc()) { ?>
                                ...
                                <div class="insert_class_search_div">
                                    <div class="student_search_class_input">
                                        <input type="text" id="search_box" name="search_box" class="form-control"
                                            placeholder="Search for student ID" autocomplete="off" />
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" id="insert_class_btn"
                                name="insert_class_btn">Submit</button>
                        </div>
                        <!-- end the form -->
                    </div>
                </div>

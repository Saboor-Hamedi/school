            ...
            <div class="card-body" id="turn-on-scroll">
                <div >
                    ...
                    <table class="table table-bordered table-dark">
                        ...
                        $query_rearch = $db->select($query);
                        $count_row = mysqli_num_rows($query_rearch);
                        if ($count_row <= 0) {
                            echo '
                                ...
                                while ($row = $query_rearch->fetch_assoc()) { ?>
                                    <tbody id="student_table_body">
                                        <tr>
                                            ...
                                            <td class="link">
                                                <a href="../visit/visit-student-account.php?id=<?php echo base64_encode($row['nim']); ?>" target="__blank"><?php echo $row['nim']; ?></a>
                                            </td>
                                            <td>
                                                <?php echo $row['name']; ?>
                                            </td>
                                            ...
                                            <td>
                                                <a id="<?php echo $row['id']; ?>" class="student_view" data-toggle="modal" data-target="#student_update_modal"> <i class="far fa-edit"></i>
                                                </a>
                                            </td>
                                            <td><i class="fas fa-trash-alt" id="student_delete_btn" onclick="delete_student('<?php echo $row['id'] ?>')"></i>
                                            </td>
                                        </tr>
                                    </tbody>
                        <?php }}} ?>

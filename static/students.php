                ...
                <div class="col-12 col-md-12 col-xxl-9" id="row-gap">
                    <div class="card flex-fill w-100">
                        ...
                        <div class="export-buttons">
                            <button type="button" id="btnExport" class="btn btn-primary"><i
                                  ...
                                  if ($count_row > 0) {
                                    ...
                                    <tbody id="student_table_body">
                                        <tr>
                                            ...
                                            <td class="link">
                                                <a href="../visit/visit-student-account.php?id=<?php echo $row['nim']; ?>" target="__blank"><?php echo $row['nim']; ?></a>
                                            </td>
                                            ...
                                            <td>
                                                <a id="<?php echo $row['id']; ?>"
                                                    class="student_view" data-toggle="modal"
                                                    data-target="#student_update_modal"> <i class="far fa-edit"></i>
                                                </a>
                                            </td>
                                            <td><i class="fas fa-trash-alt" id="student_delete_btn"
                                                    onclick="delete_student('<?php echo $row['id'] ?>')"></i>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }
                ...
                <div class="col-12 col-md-12 col-xxl-3 order-1 order-xxl-1">
                    ...
                    <div class="card flex-fill ">
                        ...
                        <form id="student_insert_form" method="POST">
                            <div class="form-box">
                                <input type="text" class="form-control" oninput="process(this)"
                                    id="insert_student_id_input" name="insert_student_id_input"
                                    placeholder="Enter Student ID" autocomplete="off" />
                                <input type="text" class="form-control" id="insert_student_name_input"
                                    name="insert_student_name_input" placeholder="Enter Student Name"
                                    autocomplete="off" />
                                <input type="text" class="form-control" id="insert_student_lastname_input"
                                    name="insert_student_lastname_input" placeholder="Enter Student Last Name"
                                    autocomplete="off" />
                                <input type="text" class="form-control" id="insert_student_address_input"
                                    name="insert_student_address_input" placeholder="Enter Student Adderss"
                                    autocomplete="off" />
                                <input type="text" class="form-control" oninput="isEmail(this)"
                                    id="insert_student_email_input" name="insert_student_email_input"
                                    placeholder="Enter Student Email" autocomplete="off" />
                                <input type="text" class="form-control" oninput="process(this)"
                                    id="insert_student_age_input" name="insert_student_age_input"
                                    placeholder="Enter Student age" autocomplete="off" />
                                <input type="text" class="form-control" id="insert_student_country_input"
                                    name="insert_student_country_input" placeholder="Enter Student Country"
                                    autocomplete="off" />
                                <input type="password" class="form-control" id="insert_student_pass_input"
                                    name="insert_student_pass_input" placeholder="Enter Student Password"
                                    autocomplete="off" />
                                <input type="password" class="form-control" id="insert_student_conpass_input"
                                    name="insert_student_conpass_input" placeholder="Confirm Password"
                                    autocomplete="off" />
                            </div>
                        </form>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" id="insert_sudent_btn"
                                name="insert_sudent_btn">Submit</button>
                        </div>
                        <!-- end the form -->
                    </div>
                </div>

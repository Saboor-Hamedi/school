					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right">
								...
								<div class="dropdown-divider"></div> <a class="dropdown-item" href="../logout/logout.php">Log out</a>
							</div>
						</li>
					</ul>
				</div>
						...
						<div class="setting-panel">
							...
							<div class="setting-card">
								...
								<form id="admin_change_password_form" method="POST">
									...
									<div class="form-box">
										<input type="password" name="old_student_password" class="form-control" id="old_student_password" placeholder="Enter your old password" autocomplete="off">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary" id="change_astudent_password_btn" name="change_astudent_password_btn">Change</button>
									</div>
								</form>
							</div>
						</div>
